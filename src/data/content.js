export const SCHOOL_INFO = {
  ...
  address: "Rua Principal de Ensino, São Paulo - SP",
...
export const COURSES = [
  {
    id: "ingles",
    title: "Inglês Prático & Conversação",
    subtitle: "Do Básico ao Avançado com foco em fluência real",
    duration: "Módulos Flexíveis | 100% Presencial",
    badge: "Alta Procura",
    description: "Método dinâmico e focado no uso diário do idioma. Desenvolva fala, audição, leitura e escrita sem medo de errar, com turmas niveladas por faixa etária.",
    modules: [
      "Conversação desde as primeiras aulas",
      "Gramática prática e vocabulário cotidiano",
      "Simulações de entrevistas e viagens",
      "Material didático moderno e interativo",
    ],
    whatsappMsg: "Olá! Gostaria de saber mais sobre o curso presencial de Inglês na Educa Digital Planets!",
    cta: "Saber Mais no WhatsApp",
  },
  {
    id: "informatica",
    title: "Informática Profissionalizante",
    subtitle: "Domine as ferramentas essenciais para qualquer empresa",
    duration: "Completo | Computador Individual",
    badge: "Essencial para Emprego",
    description: "Aprenda na prática o que o mercado corporativo exige: Windows, Pacote Office (Excel básico ao avançado, Word, PowerPoint), internet segura e rotinas administrativas.",
    modules: [
  ...
  },
  {
    ...
    subtitle: "Habilidades comportamentais e comerciais de alto impacto",
    duration: "Prático & Aplicado | 100% Presencial",
    badge: "Destaque Profissional",
    description: "Desenvolva a capacidade de falar em público com segurança, negociar com clareza, atender clientes com excelência e se destacar em processos seletivos.",
    modules: [
      "Oratória, postura e desinibição",
      "Técnicas modernas de vendas e negociação",
      "Atendimento ao cliente e resolução de problemas",
      "Marketing pessoal e comportamento assertivo",
    ],
    whatsappMsg: "Olá! Gostaria de saber mais sobre o curso de Comunicação e Vendas na Educa Digital Planets!",
    cta: "Saber Mais no WhatsApp",
  },
  {
    id: "reforco",
