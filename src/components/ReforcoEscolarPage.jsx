    ...
    <div className="min-h-screen bg-[#f8fafc] text-slate-800 font-sans selection:bg-[#3774B0] selection:text-white flex flex-col">
      ...
      >
        <a
          ...
          className="relative flex items-center justify-center w-14 h-14 sm:w-16 sm:h-16 bg-[#25D366] hover:bg-[#20bd5a] active:bg-[#1caa4f] text-white rounded-full shadow-[0_8px_30px_rgba(37,211,102,0.45)] hover:shadow-[0_12px_35px_rgba(37,211,102,0.65)] transition-all duration-300 hover:scale-110 active:scale-95 focus:outline-hidden"
        >
